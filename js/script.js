...
let spollersInit = (footerSpollers, isOpen) => {
  footerSpollers.forEach(footerSpoller => {
    const menuFooterTitle = footerSpoller.querySelector('.menu-footer__title');
    footerSpoller.classList.toggle('_init', !isOpen)
    isOpen ? menuFooterTitle.setAttribute("tabindex", "-1") : menuFooterTitle.removeAttribute("tabindex") 
